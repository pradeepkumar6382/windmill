...
function createData(date, person, In, out) {
    return { date, person, In, out };
}

const rows = [
    createData('27-01-2024', 'test', '10:00 AM', '05:00 PM'),
];
                    ...
                    <TableBody>
                        {rows.map((row) => (
                            <StyledTableRow key={row.name}>
                                ...
                                <StyledTableCell align="right">{row.out}</StyledTableCell>
                            </StyledTableRow>
                        ))}
                    </TableBody>
                </Table>
